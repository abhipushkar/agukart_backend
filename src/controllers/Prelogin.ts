                ...
                initialValue: "",
                    in: {
                      $concat: [
                        "$$value",
                        " ",
                        { $convert: { input: "$$this.variant_name", to: "string", onError: "", onNull: "" } },
                        " ",
                        {
                          $reduce: {
                            ...
                            in: {
                              $concat: [
                                "$$value",
                                " ",
                                { $convert: { input: "$$this.attribute", to: "string", onError: "", onNull: "" } }
                              ]
                            }
                          }
                        }
                ...
                input: { $ifNull: ["$customizationData.customizations", []] },
                  ...
                  in: {
                    $concat: [
                      "$$value",
                      " ",
                      { $convert: { input: "$$this.title", to: "string", onError: "", onNull: "" } },
                      " ",
                      { $convert: { input: "$$this.label", to: "string", onError: "", onNull: "" } }
                    ]
                  }
                }
              }
                              ...
                              $let: {
                                vars: {
                                  ...
                                  variantNameMatches: {
                                    $filter: {
                                      ...
                                      cond: {
                                        $regexMatch: {
                                          input: "$$variant.variantNameLower",
                                          regex: {
                                            $concat: [
                                              "(^|[^a-z0-9])",
                                              { $toLower: "$$word" },
                                ...
                                in: {
                                  $add: [
                                    {
                                      $multiply: [
                                        { $size: "$$attributeMatches" },
                                        2000
                                      ]
                                    },
                                    {
                                      $multiply: [
                                        { $size: "$$variantNameMatches" },
                                        500
                                      ]
                                    },
                                    {
            ...
            $cond: [
              {
                $and: [
                  { $eq: ['$isCombination', true] },
                  { $eq: ['$form_values.isCheckedPrice', true] },
                  { $ne: ['$matchedVariant', null] },
                  { $ne: [{ $ifNull: ['$matchedVariant.image', ''] }, ''] },
                  { $ne: [{ $ifNull: ['$form_values.prices', ''] }, ''] }
                ]
              },
              {
                $let: {
                                    ...
                                    $and: [
                                      {
                                        $eq: [
                                          {
                                            $toLower: {
                                              $ifNull: ['$$combination.priceInput', '']
                                            }
                                          },
                                          {
                                            $toLower: {
                                              $ifNull: ['$form_values.prices', '']
                                            }
                                          }
                                        ]
                                      },
                                              ...
                                              $filter: {
                                                ...
                                                cond: {
                                                  $eq: [
                                                    ...
                                                    {
                                                      $toLower: {
                                                        $ifNull: ['$matchedVariant.attribute', '']
                                                      }
                                                    }
                                                  ]
                                                }
                    ...
                    $let: {
                      ...
                      in: {
                        $cond: [
                          {
                            $gt: [
                              { $size: '$$validMatchedPrices' },
                              0
                            ]
                          },
                          {
                            $min: '$$validMatchedPrices'
                          },
                          null
                        ]
                      }
            ...
            $let: {
              vars: {
                ...
                in: {
                  $let: {
                    vars: {
                      scoredCustomizations: {
                        $map: {
                          input: "$$allCustomizations",
                          as: "customization",
                          in: {
                                ...
                                vars: {
                                  matchedWords: {
                                    $filter: {
                                      ...
                                      cond: {
                                        $regexMatch: {
                                        input: "$$customization.optionNameLower",
                                          regex: {
                                            $concat: [
                                              "(^|[^a-z0-9])",
                                              { $toLower: "$$word" }
                      ...
                      $let: {
                        ...
                        in: {
                          $cond: [
                            {
                              $and: [
                                { $ne: ["$$bestCustomization", null] },
                                {
                                  $gt: [
                                    "$$bestCustomization.score",
                                    0
                                  ]
                                }
                              ]
                            },
                            "$$bestCustomization.customization",
                            null
                          ]
                        }
                      }
